...
api_key_imp = os.environ['OPENAI_KEY']
...
# ❗️Vervang onderstaande waarden door je eigen gegevens
storage_account_name = os.environ['storage_account_name']
container_name = os.environ['containerhhh']
bestandspad = f"Rooster_output_HHH_{REFERENCE_YEAR}_{REFERENCE_MONTH:02d}.xlsx"
blob_name = bestandspad
sas_token = os.environ['sas_token']

# Stel de volledige URL samen met SAS-token
...
# Upload het bestand
with open(bestandspad, "rb") as data:
